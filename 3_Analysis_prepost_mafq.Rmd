...
sim_slopes(mlm_caudate_r_win_prepost_z, pred=aleq_c.L1_z, modx=caudate_r_prepost_resWIN, jnplot=TRUE)
sjPlot::tab_model(
  mlm_caudate_r_win_prepost_z, 
  bootstrap = TRUE,
  iterations = 1000, 
...
sim_slopes(mlm_putamen_l_win_prepost_z, pred=aleq_c.L1_z, modx=putamen_l_prepost_resWIN, jnplot=TRUE)
...
sim_slopes(mlm_putamen_r_win_prepost_z, pred=aleq_c.L1_z, modx=putamen_r_prepost_resWIN, jnplot=TRUE)
